...
{
  public partial class ClearHtmlCacheOnInstance : System.Web.UI.Page
  {
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (machineName.Equals(instanceName, StringComparison.InvariantCultureIgnoreCase))
      {
        ...
        {
          if (allCach.Name.Contains("[html]"))
          {
            Sitecore.Diagnostics.Log.Info(string.Format("CUSTOMCACHECLEANUP. cleanup cache '{0}'", allCach.Name), this);
            allCach.Clear();
          }
        }
